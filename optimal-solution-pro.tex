...
\begin{problem}
В каждой транспортной таблицы выписано базисное допустимое решение. 
Определите, какие переменные могут быть базисными, а какие — не могут быть базисными. 
  \begin{enumerate}
    \item 
  ...
  \begin{sol}
    ...
    Знаком «+» отмечены переменные, которые \textit{могут} быть базисными.
    Знаком «—» отмечены переменные, которые \textit{не могут} быть базисными.
