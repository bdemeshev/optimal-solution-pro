...
\begin{leftbar}
  ...
  \item источник, source, \chinesetext{源点};
  \item сток, sink, \chinesetext{汇点};
...
\end{tikzpicture}
    ...
    \begin{enumerate}
      \item Найдите пропускную способность разреза $c(S, T)$ для $S = \{s, b, c\}$, $T = \{d, e, g, t\}$. 
      \item Найдите пропускную способность разреза $c(S, T)$ для $S = \{s, b, g, e\}$, $T = \{c, d, t\}$. 
