...
\begin{leftbar}
  ...
  \begin{align*}
    y_j^* \neq 0 & \Rightarrow & a_{j1} x_1^* + a_{j2} x_2^* + a_{j3} x_3^* = b_j  \\
    a_{1i} y_1^* + a_{2i} y_2^* \neq c_i & \Rightarrow & x_i^* = 0 \\
  \end{align*}  
\end{leftbar}
...
\begin{sol}
  \begin{enumerate}
    ...
    \item $x_1 = 0$, $x_2 = 0$, $x_3 = 5 + x_4$, $x_4 \geq 0$, $z=5$.
    Можно записать ответ в виде $x \in A + \cone(u)$, где $A = (0, 0, 5, 0)$, $u = (0, 0, 1, 1)$.
  \end{enumerate}
