...
\begin{enumerate}
 ...
 \[
  u = u_1 + u_2 + u_3.
 \]
 \item Определите оптимальный выбор для четырёх периодов с дисконт-фактором $0.5$,
 \[
  u = u_1 + 0.5 u_2 + 0.5^2 u_3 + 0.5^3 u_4.
 \]
...
\begin{enumerate}
 ...
 \[
  u = u_1 + u_2 + u_3.
 \]
 \item Определите оптимальное поведение кота  для четырёх периодов с дисконт-фактором $0.5$,
 \[
  u = u_1 + 0.5 u_2 + 0.5^2 u_3 + 0.5^3 u_4.
 \]
...
Оставшийся капитал можно положить под процентную ставку $5\%$ до следующего периода, $y_{t+1} = 1.05 \cdot (y_t - x_t)$.
...
\begin{enumerate}
 ...
 \[
  u = u_1 + u_2 + u_3.
 \]
 \item Определите оптимальное поведение Пикачу для четырёх периодов с дисконт-фактором $0.5$,
 \[
  u = u_1 + 0.5 u_2 + 0.5^2 u_3 + 0.5^3 u_4.
 \]
 \item Определите оптимальное поведение Пикачу для бесконечного количества периодов с дисконт-фактором $0.7$,
 \[
 u = \sum_{t=1}^{\infty} 0.7^{t-1} u_t.
 \]
\end{enumerate}
