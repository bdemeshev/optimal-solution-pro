...
\begin{problem}
  ...
  \begin{enumerate}
    ...
    \item Выпишите матрицу смежности для вершин $A$, $B$, $C$ и $D$.
  \end{enumerate}
...
\begin{problem}
Матрица смежности взвешенного графа равна
\[
  M = \begin{pmatrix}
    \infty & 4 & \infty & 2 \\
    2 & \infty & 1 & \infty \\
...
\begin{enumerate}
  \item Нарисуйте граф. 
  \item Найдите матрицу $A = M^2$. Какой смысл у элемента $a_{23}$?
  \item Найдите матрицу $B = M^3$. Какой смысл у элемента $b_{23}$?
\end{enumerate}
