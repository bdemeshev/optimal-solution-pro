...
% TODO: на цену позиции включить задачи
...
\begin{enumerate}
 ...
 \item $xy \to \max$ при условии $2x + y = 600$, $x \geq 0$, $y \geq 0$.
 \item $xy \to \max$ при условии $2x + y = 400$, $x \geq 0$, $y \geq 0$.
 \item $300 = 0.5x + 0.5x + y \geq 3 \sqrt[3]{0.5x\cdot 0.5x \cdot y}$, следовательно, $x = 200$, $y=100$, $\max f = 4 000 000$;
...
\begin{leftbar}
\begin{itemize}
 \item Уравнение Беллмана, Bellman equation,
...
Мгновенная удовольствие кота равно $u_t = \ln x_t$.
...
\begin{enumerate}
 ...
 \[
 u = \lim_{T\to\infty} \sum_{t=1}^{T} u_t / T \to \max.
 \]
...
\begin{enumerate}
 ...
 \[
 u = \sum_{t=1}^{\infty} 0.7^{t-1} u_t \to \max.
 \]
